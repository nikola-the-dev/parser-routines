...
# Private methods        
    ...
    def _get_page_url(self):
        ...
        return urlunsplit(("https", domain, self.category, query_string, ""))
...
# Public methods
    ...
    def parse(self):
        print(f"Start parsing category {self.category}...")
        while not self.reaches_end:
            self._get_next_page()
        print(f"{len(self.items)} items found in {self.category}")